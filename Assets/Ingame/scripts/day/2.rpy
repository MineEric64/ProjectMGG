...
label start:
	...
	"특히나 지금 홈베이스에는 아무도 없다. 창문이 열려있어 차가운 바람이 살살 불어온다."
	"… 어우 무거워."
	"나는 들고 있던 포스터 전부를 바닥에 내려놓았다. 어차피 여기서 포스터를 붙일 거니까."
	"어우 편하다. 그럼 이제 포스터를 붙여볼까?"
	"내가 포스터 하나를 집으려고 하자, 세아 선배는 단호한 목소리로 반응했다."
	...
	"그리고 선배는 포스터를 붙이기 위해 양손을 위로 쭉 뻗었다."
	"세아 선배가 끙끙대며 까치발을 드는 모습이 귀여워 보였다."
	"하지만 곧 세아 선배의 몸이 휘청거리기 시작했다."
	...
	player "선배님 괜찮으세요···?"
	seah "…"
	"내가 말을 꺼내도 달라지는 건 없었다. 여전히 나는 언짢게 세아 선배를 품에 안기고 있었다."
	"지금 이 상황에서 어떻게 해야 할지 모르겠다는 눈빛으로 나를 흘끗 보더니, 민망한 듯 다시 시선을 피했다."
	...
	"그러곤 발을 동동 구르더니, 나를 물끄러미 바라본다."
	"나에게 무슨 할 말이 있는걸까? 세아 선배는 조심스러워 하는 기색으로 말을 꺼냈다."
	seah "저.. 포스터 같이 붙이면 안될까요오···?"
	seah "저 혼자 포스터를 붙이다가.. 아까처럼 넘어지며언······."
	player "음.. 알겠어요 선배님. 그럼 이건 어때요?"
	player "제가 포스터 위쪽을 붙일테니, 선배님은 아래쪽을 붙이는거죠."
	seah "오! 그건 생각 못했네요 ㅎ.."
	seah "고마워요 남주씨!"
	...
	seah "좀만 더···."
	player "됐죠?"
	seah "좋아요! 그대로 가만히 냅두면 돼요. 제가 그동안 테이프로 붙이고 있을게요."
	"세아 선배는 테이프를 쫘악 뜯다, 문득 작은 목소리로 이야기를 꺼냈다."
	seah "혹시 남주씨는.. 취미가 뭐에요···?"
	"첫 이야기 중에서도 하필이면 대답하기 어려운 질문이라니···."
	player "아, 저 애니메이션을 보면서 감상…하는 게 제 취미에요."
	"애니 본다는 게 부끄러운 건 아니잖아?"
	seah "오! 저 애니메이션 하나 본 거 있어요. 아실려나···?"
	"오!? 애니를 봤다고?? 괜히 궁금해진다."
	player "뭔데요?!"
	seah "장구는 못말려라고, 최근에 나온거 봤는데 재밌더라구요."
	player "아···."
	player "세아 선배님은 취미가 뭐에요?"
	seah "아, 저는 주로 꽃을 보러 나가요."
	seah "방송실에 꽃이 있는거 봤죠?"
	player "네. 세아 선배님이 다 꾸며놓으신건가요?"
	seah "네! 제가 꽃으로 방 꾸미는 걸 좋아해서.."
	"아, 아까 방송실에 갔을 때 꽃이 여러 개 있는 이유가 그거였구나."
	seah "그리고··· 그 중에 알스트로메리아란 꽃은······."
	"그 뒤로 목소리가 작아져서 선배의 말이 들리지가 않았다."
	player "아! 알스트로메리아 꽃 되게 예쁘더라고요."
	"아까 여러모로 눈에 띄었던 그 꽃의 이름이다."
	player "그나저나 아까 뭐라고 하셨어요? 잘 못 들어서.."
	seah "아니에요오···."
	"세아 선배는 테이프를 다시 힘껏 뜯어, 내 옆으로 천천히 다가왔다."
	"이번에는 테이프를 손에 건내지 않고 세아 선배가 직접 붙여줬다."
	"선배가 테이프를 한땀한땀 붙이는 동안 나는 가만히 있을 수 밖에 없었다. 만약 한 발짝 움직이기라도 했다면, 세아 선배 어깨에 닿고 말았을 것이다."
	"세아 선배는 내가 이렇게 가까이 있다는 것조차 눈치 채지 못한 듯하다. 여전히 테이프 하나하나를 고심 끝에 붙이고 있었다."
	"잠시 후, 세아 선배는 테이프를 바닥에 놓고 포스터를 멀리서 보려고 뒷걸음질을 쳤다."
	"선배는 붙인 포스터가 만족스러웠는지 표정에 환한 미소가 흘러넘치고 있었다."
	"세아 선배의 눈부신 웃음에 나도 왠지 모르게 뿌듯해졌다."
