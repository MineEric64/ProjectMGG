using ProjectMGG.UI.UnityEqualizer;
using System.Collections;
using System.Collections.Generic;
using UnityEngine;

namespace ProjectMGG.UI.UnityEqualizer
{
    public class LightingEqualizer : MonoBehaviour //This library is from https://github.com/apiedev/unity-equalizer
    {
        ...
        private void Awake()
        {
            ...
            if (analyzer == null)
                analyzer = GameObject.FindFirstObjectByType<AudioAnalyzer>();
